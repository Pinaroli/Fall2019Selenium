...
public class WarmUpMethods {
    ...
    public static void main(String[] args) throws Exception {
        //we need to get a title: get title method returns top of the webpage enustdeki title verir always
        //split them by space then you can find the first item with[0]
        // String[] searchSentence=searchResult.getText().split(" ")[0];
       // String title=driver.getTitle(); //when you find search button get page title
        //if title contains java book test passed otherwise test failed(if else method)
    ebayTest();
    amazonTest();
    wikiTest();
