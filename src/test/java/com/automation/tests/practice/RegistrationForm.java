...
public class RegistrationForm {
    ...
    public void verifyFirstNameLengthTest(){
        /**
         * <small class="help-block" data-bv-validator="stringLength" data-bv-for="firstname"
         * data-bv-result="INVALID"
         * style="">first name must be more than 2 and less than 64 characters long</small>
         */
    ...
    public void verifyAlphabeticLettersOnlyTest(){
        /***
         *<small class="help-block" data-bv-validator="regexp" data-bv-for="firstname"
         * data-bv-result="INVALID"
         * style="display: block;">first name can only consist of alphabetical letters</small>
         */
